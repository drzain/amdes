...
public class SessionManager {
    ...
    private static final String PREF_NAME = "SobatExpress";
    ...
    private static final String KEY_IS_TOKEN = "isToken";
    private static final String KEY_IS_FOTO = "isFoto";
    ...
    public void setToken(String isToken){
        editor.putString(KEY_IS_TOKEN, isToken);
        editor.commit();
        Log.d(TAG, "Token session modified");
    }

    public void setFoto(String isFoto){
        editor.putString(KEY_IS_FOTO, isFoto);
        editor.commit();
        Log.d(TAG, "Foto session modified");
    }
